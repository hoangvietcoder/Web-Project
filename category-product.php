<?php
    ...
    $category = GetCategoryByID($id_danhmuc);
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="col-sm-10">
                <div class="box-breadcrumb mar-t-25">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><?php echo $category['tendanhmuc'] ?></li>
                    </ol>
                </div>
                <h1 class="category-title"><?php echo $category['tendanhmuc'] ?></h1>
                <div class="main-content mar-t-50">
                    <?php
                        $products = GetProductByIdCategory($category['id_danhmuc']);
                        $item_count = 0;
                        $item_column = 0;
