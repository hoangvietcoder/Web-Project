...
<main>
    <div class="card mb-4">
        ...
        <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
            <div class="row" style="float: left; margin-top: 10px; margin-left: 30px;">
                <a class="btn btn-info btn-sm" href="developer.php?select=themungdung" class="edit" title="Edit" data-toggle="tooltip">
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="col-sm-12">
                            <table class="table table-bordered dataTable w-100" id="dataTable" cellspacing="0" role="grid" aria-describedby="dataTable_info">
                                ...
                                <tbody>
                                    <?php
                                        $dev_product = GetProductByDevId($user['id_user']);
                                    ...
                                    ?>
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="project-actions text-center align-middle">
                                                <a class="btn btn-info btn-sm mr-3" href="edit_product.php?id_product=<?php echo $product['id_product']; ?>" class="edit" title="Edit" data-toggle="tooltip">
                                                    <i class="fas fa-pencil-alt"></i> Chỉnh sửa
                                                </a>
                                                <a href="developer.php?select=upload_product&id_delete=<?php echo $product['id_product'] ?>" class="btn btn-danger btn-sm button-call-delete">
